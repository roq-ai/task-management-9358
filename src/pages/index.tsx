  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Task Management Kanban: Streamlining your project workflow by assigning tasks, managing statuses, and staffing with an intuitive kanban board."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1611224885990-ab7363d1f2a9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxrYW5iYW4lMjBib2FyZHxlbnwwfHx8fDE2OTU4MzQ4MzJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Task Management Kanban: Streamlining your project workflow by assigning tasks, managing statuses, and staffing with an intuitive kanban board.`}
            </Text>
            <Box
